  ...
  return (
    ...
    {projectInfoOpen && <div className="fixed inset-0 z-50 flex items-end bg-[#20232d]/30 p-0 backdrop-blur-[2px] sm:items-center sm:justify-center sm:p-6" role="dialog" aria-modal="true" aria-labelledby="mattr-chat-info-title">
      ...
      <section className="relative max-h-[calc(100dvh-1rem)] w-full overflow-y-auto rounded-t-[24px] border border-white/80 bg-white px-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] pt-5 shadow-[0_22px_60px_rgba(30,35,52,0.22)] sm:max-w-[560px] sm:rounded-[22px] sm:p-6">
        <div className="flex items-start justify-between gap-4"><div><div className="flex items-center gap-2"><BrandMark /><span className="text-[12px] font-semibold text-[#4e5670]">Mattr Chat</span></div><h2 id="mattr-chat-info-title" className="mt-3 text-[22px] font-semibold tracking-[-0.035em] text-[#252832]">Why Mattr Chat exists.</h2></div><button onClick={() => setProjectInfoOpen(false)} className="grid h-10 w-10 shrink-0 place-items-center rounded-[10px] text-[#747985] transition-colors hover:bg-[#f1f2f5]" aria-label="Close"><X className="h-4 w-4" /></button></div>
        <p className="mt-3 text-[13px] leading-6 text-[#676d7b]">This is a hands-on project for learning what turns a local language model into a useful shared chat experience.</p>
        <div className="mt-5 grid gap-2.5 sm:grid-cols-2"><div className="rounded-[14px] border border-[#e4e7ef] bg-[#f8f9fc] p-3"><p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#70799e]">Model serving</p><p className="mt-1.5 text-[12px] leading-5 text-[#555b69]">How a local model receives prompts and generates answers.</p></div><div className="rounded-[14px] border border-[#e4e7ef] bg-[#f8f9fc] p-3"><p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#70799e]">Shared requests</p><p className="mt-1.5 text-[12px] leading-5 text-[#555b69]">How several conversations can be handled fairly without feeling slow.</p></div><div className="rounded-[14px] border border-[#e4e7ef] bg-[#f8f9fc] p-3"><p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#70799e]">Context &amp; KV cache</p><p className="mt-1.5 text-[12px] leading-5 text-[#555b69]">How chat context and model memory affect speed, continuity, and limits.</p></div><div className="rounded-[14px] border border-[#e4e7ef] bg-[#f8f9fc] p-3"><p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#70799e]">Security</p><p className="mt-1.5 text-[12px] leading-5 text-[#555b69]">How access and requests should be handled responsibly.</p></div></div>
        <div className="mt-3 rounded-[14px] border border-[#ece6d7] bg-[#fffdf7] p-3"><p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#8b774b]">Current limits</p><p className="mt-1.5 text-[12px] leading-5 text-[#5f5a4d]">It is an ongoing learning project, so availability and response speed can vary. Verify important answers and avoid sharing sensitive personal information.</p></div>
